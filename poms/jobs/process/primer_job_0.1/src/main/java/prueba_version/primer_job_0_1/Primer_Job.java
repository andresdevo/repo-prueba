...
package prueba_version.primer_job_0_1;
...
public class Primer_Job implements TalendJob {
	...
	private final String projectName = "PRUEBA_VERSION";
	...
	JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_2SvjUA-UEeqS4OrnOFyr1Q", "0.1");
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_PRUEBA_VERSION_Primer_Job = new byte[0];
		static byte[] commonByteArray_PRUEBA_VERSION_Primer_Job = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PRUEBA_VERSION_Primer_Job.length) {
					if (length < 1024 && commonByteArray_PRUEBA_VERSION_Primer_Job.length == 0) {
						commonByteArray_PRUEBA_VERSION_Primer_Job = new byte[1024];
					} else {
						commonByteArray_PRUEBA_VERSION_Primer_Job = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PRUEBA_VERSION_Primer_Job, 0, length);
				strReturn = new String(commonByteArray_PRUEBA_VERSION_Primer_Job, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PRUEBA_VERSION_Primer_Job) {
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Primer_Job.class.getClassLoader()
					.getResourceAsStream("prueba_version/primer_job_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 44203 characters generated by Talend Cloud Big Data on the 25 de noviembre de
 * 2019 17:54:28 CET
 ************************************************************************************************/